...
export default function NewsMediaPage() {
 return <main id="main" className="media-page">
  ...
  <section className="container section work-cta"><div className="work-cta-card"><div><p className="eyebrow">Media & Public Information</p><h2>Looking for Information About the Society?</h2><p>Journalists, associations and organisations seeking information about the Society’s activities, documents or electricity-billing initiatives may contact us.</p></div><Link href="/#contact" className="button">Contact Us <ArrowRight size={18}/></Link></div></section>
 </main>;
}
