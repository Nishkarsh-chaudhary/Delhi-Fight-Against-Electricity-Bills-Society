      ...
      <section className="inner-hero bill-help-hero">
        <div className="container inner-hero-grid">
          <div>
            ...
            <div className="bill-help-actions">
              <a href="#components" className="button accent">Understand My Bill <ArrowRight size={17} /></a>
              <a href="#submit-concern" className="button secondary">Submit a Billing Concern</a>
            </div>
          </div>
